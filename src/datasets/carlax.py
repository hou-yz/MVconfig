...
class CarlaX(VisionDataset):
    def __init__(self, opts, seed=None, root=os.path.expanduser("~/Data/CarlaX"), port=2000, tm_port=8000):
        ...
        self.env = CarlaCameraSeqEnv(opts, seed, port=port, tm_port=tm_port)
